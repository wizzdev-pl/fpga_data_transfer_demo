## LEDs #####################################################################
set_property PACKAGE_PIN A13 [get_ports {debug_LEDs[0]}]
set_property PACKAGE_PIN B13 [get_ports {debug_LEDs[1]}]
set_property PACKAGE_PIN A14 [get_ports {debug_LEDs[2]}]
set_property PACKAGE_PIN A15 [get_ports {debug_LEDs[3]}]
set_property PACKAGE_PIN B15 [get_ports {debug_LEDs[4]}]
set_property PACKAGE_PIN A16 [get_ports {debug_LEDs[5]}]
set_property PACKAGE_PIN B16 [get_ports {debug_LEDs[6]}]
set_property PACKAGE_PIN B17 [get_ports {debug_LEDs[7]}]
set_property IOSTANDARD LVCMOS15 [get_ports {debug_LEDs[*]}]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {clk_200MHz}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {mig_clk}]

#create_clock -name sys_clk -period 5 [get_ports sys_clkn]
set_clock_groups -asynchronous -group [get_clocks {clk_200MHz}] -group [get_clocks {mmcm0_clk0 okUH0}]
...
set_property DONT_TOUCH true [get_cells mig_inst/u_mig_7series_1_mig/u_memc_ui_top_std/u_ui_top/ui_wr_data0/write_buffer.wr_buffer_ram[0]]